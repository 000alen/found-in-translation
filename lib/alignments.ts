...
export const GROUP_COLORS = [
  { id: "violet", bar: "bg-violet-500", bg: "bg-violet-500/10", ring: "ring-violet-500/30", text: "text-violet-700 dark:text-violet-300" },
  { id: "sky", bar: "bg-sky-500", bg: "bg-sky-500/10", ring: "ring-sky-500/30", text: "text-sky-700 dark:text-sky-300" },
  { id: "emerald", bar: "bg-emerald-500", bg: "bg-emerald-500/10", ring: "ring-emerald-500/30", text: "text-emerald-700 dark:text-emerald-300" },
  { id: "amber", bar: "bg-amber-500", bg: "bg-amber-500/10", ring: "ring-amber-500/30", text: "text-amber-700 dark:text-amber-300" },
  { id: "rose", bar: "bg-rose-500", bg: "bg-rose-500/10", ring: "ring-rose-500/30", text: "text-rose-700 dark:text-rose-300" },
  { id: "indigo", bar: "bg-indigo-500", bg: "bg-indigo-500/10", ring: "ring-indigo-500/30", text: "text-indigo-700 dark:text-indigo-300" },
  { id: "teal", bar: "bg-teal-500", bg: "bg-teal-500/10", ring: "ring-teal-500/30", text: "text-teal-700 dark:text-teal-300" },
  { id: "fuchsia", bar: "bg-fuchsia-500", bg: "bg-fuchsia-500/10", ring: "ring-fuchsia-500/30", text: "text-fuchsia-700 dark:text-fuchsia-300" },
] as const;
